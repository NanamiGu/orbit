...
export default function FinalCTA() {
  ...
  return (
    <section className="bg-slate-950 py-24 sm:py-32 relative overflow-hidden" id="contact">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-175 h-87.5 bg-linear-to-r from-emerald-500/15 via-teal-500/10 to-cyan-500/15 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative rounded-3xl p-10 sm:p-14 lg:p-16 bg-linear-to-b from-slate-900/90 via-slate-900/70 to-slate-950/90 border border-emerald-500/30 text-center shadow-2xl backdrop-blur-xl">
          
          {/* Subtle top light bar */}
          <div className="absolute top-0 inset-x-12 h-px bg-linear-to-r from-transparent via-emerald-400 to-transparent" />

          {/* Headline */}
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight mb-4 leading-tight max-w-3xl mx-auto">
            {t("finalCta.headline")}
          </h2>
